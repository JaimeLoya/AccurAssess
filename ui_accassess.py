...
class Ui_AccAssess(object):
    def setupUi(self, AccAssess):
        AccAssess.setObjectName(_fromUtf8("AccurAssess"))
    ...
    def retranslateUi(self, AccAssess):
        AccAssess.setWindowTitle(QtGui.QApplication.translate("AccurAssess", "AccurAssess", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("AccurAssess", "Reference Map (Truth)", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("AccurAssess", "Map Under Assessment", None, QtGui.QApplication.UnicodeUTF8))
        self.outFileLabel.setText(QtGui.QApplication.translate("AccurAssess", "CSV Output File", None, QtGui.QApplication.UnicodeUTF8))
        
    
        self.outFileSelectButton.setText(QtGui.QApplication.translate("AccurAssess", "Select...", None, QtGui.QApplication.UnicodeUTF8))
